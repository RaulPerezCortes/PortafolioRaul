...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'door.menu': 'Menu',
    'door.back': 'Volver a la habitacion',
    'door.about': 'Sobre mi',
    'door.portfolio': 'Portfolio',
    'door.blog': 'Blog',
    'door.game': 'Juego',
    'door.language': 'Idioma',
    'door.theme': 'Tema',
    'door.dark': 'Oscuro',
    'door.light': 'Claro',
    'controls.title': 'Controles',
    'controls.rotate': 'Click + arrastrar para mirar alrededor.',
    'controls.zoom': 'Rueda / pellizcar para moverte con zoom.',
    ...
    'controls.move.short': 'Mover vista',
    'controls.zoom.short': 'Hacer zoom',
  },
  en: {
    ...
    'door.menu': 'Menu',
    'door.back': 'Back to the room',
    'door.about': 'About me',
    'door.portfolio': 'Portfolio',
    'door.blog': 'Blog',
    'door.game': 'Game',
    'door.language': 'Language',
    'door.theme': 'Theme',
    'door.dark': 'Dark',
    'door.light': 'Light',
    'controls.title': 'Controls',
    'controls.rotate': 'Click + drag to look around.',
    'controls.zoom': 'Wheel / pinch to move with zoom.',
    ...
    'controls.move.short': 'Move view',
    'controls.zoom.short': 'Zoom',
  },
};
